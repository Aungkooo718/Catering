    ...
    <div class="main-content">
      ...
      <input style="padding:8px;" type = "file" name = "file" value = "Browse File" /> 
        ...
        <main>           
          ...
          <form action="#" 
  th:action="@{/updateEmployee/{id}(id=${emp.id})}" 
  th:object="${emp}" 
  method="post">
    <label for="name">Name</label>
    <input type="text" th:field="*{name}" th:value="*{name}" id="name" placeholder="Name">
    <span th:if="${#fields.hasErrors('name')}" th:errors="*{name}"></span>
    <label for="email">Email</label>
    <input type="text" th:field="*{email}" th:value="*{name}" id="email" placeholder="Email">
    <span th:if="${#fields.hasErrors('email')}" th:errors="*{email}"></span>
    
    <label for="staffId">Staff ID</label>
    <input type="text" th:field="*{staffId}" th:value="*{staffId}" id="staffId" placeholder="Staff Id">
    <span th:if="${#fields.hasErrors('staffId')}" th:errors="*{staffId}"></span>
    <label for="doorLogNo">Door Log</label>
    <input type="text" th:field="*{doorLogNo}" th:value="*{doorLogNo}" id="doorLogNo" placeholder="DoorLogNo">
    <span th:if="${#fields.hasErrors('doorLogNo')}" th:errors="*{doorLogNo}"></span>
    
    <label for="role">Staff ID</label>
    <input type="text" th:field="*{role}" th:value="*{role}" id="role" placeholder="Role">
    <span th:if="${#fields.hasErrors('role')}" th:errors="*{role}"></span>
    <label for="department">Department</label>
    <input type="text" th:field="*{department}" th:value="*{department}" id="department" placeholder="department">
