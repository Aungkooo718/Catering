...
<body class="mainbody">
    ...
    <div class="main-content">
      ...
      <input style="padding:8px;" type = "file" name = "file" value = "Browse File" /> 
        ...
        <main>           
          ...
          <form id="edit_form" th:action="@{/updateEmployee}" th:object="${emp}" method="post">
    <label for="name">Name</label>
    <input type="text" th:field="*{name}" name="name" th:value="*{name}" placeholder="Name">
    <span th:if="${#fields.hasErrors('name')}" th:errors="*{name}" class="error-message"></span>

    <label for="email">Email</label>
    <input type="text" th:field="*{email}" th:value="*{email}" placeholder="Email">
    <span th:if="${#fields.hasErrors('email')}" th:errors="*{email}" class="error-message"></span>

    <label for="staffId">Staff ID</label>
    <input type="text" th:field="*{staffId}" th:value="*{staffId}" placeholder="Staff ID">
    <span th:if="${#fields.hasErrors('staffId')}" th:errors="*{staffId}" class="error-message"></span>

    <label for="doorLogNo">Door Log</label>
    <input type="text" th:field="*{doorLogNo}" th:value="*{doorLogNo}" placeholder="Door Log No">
    <span th:if="${#fields.hasErrors('doorLogNo')}" th:errors="*{doorLogNo}" class="error-message"></span>
  ...
  <select class="form-control" id="exampleFormControlSelect1" th:field="*{role}" th:value="*{role}">
    ...
    <input type="text" th:field="*{department}" th:value="*{department}" placeholder="Department">
