            ...
            <div class="col-lg-12">
                <div style="background-color:#cec4c4;" class="main-box no-header clearfix">
                    <div class="main-box-body clearfix">
                        &nbsp;&nbsp;&nbsp;<h3>Register and No-Eat Lunch Detail</h3>
                                ...
                                <tbody>
                                    <tr th:each="register : ${register}">
                                        <td>
                                            ...
                                            <span class="user-subhead" style="font-weight: bold;" th:text="${register.doorLogNo}"></span>
                                        </td>
                                        <td th:text="${date}"></td>
                                        <td class="text-center">
                                            <span class="label label-success">Register-NoEat</span>
                                        </td>
