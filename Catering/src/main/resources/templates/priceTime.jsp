   ...
   <input type="checkbox" id="menu-toggle">
    ...
    <div class="main-content">
       ...
       <div th:replace="fragments :: sub_header" ></div>
        ...
        <div class="panel-body inf-content" style="background-image: linear-gradient(to bottom, #a4c8ff 0%, #e5e5e5 100%);opacity:0.88">
            <div class="row">
                <div class="col-md-4">
                        
                       <img alt="Usuario" src="images/pr3.jpg" class="circular-image" style="">
                        
                                    </div>
                <div class="col-md-6">
      <h3 class="modern-heading">Lunch Info</h3>
                        ...
                        <table class="table table-user-information">
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <strong>
                                            <span class="glyphicon glyphicon-euro  text-primary" style="color:orange;"></span>
                                        <strong style="color:#015f4e;">Restaurant's Price:
                                            </strong>
                                        </strong>
                                    </td>
                                    <td class="text-primary" style="color:#015f4e;font-weight:bold;">
                                        [[${info.getRestaurantPrice()}]]
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <strong>
                                            <span class="glyphicon glyphicon-euro text-primary" style="color:orange;"></span>
												<strong style="color:#015f4e;">Company's Price:
                                            </strong>                                    
                                                </strong>
                                    </td>
                                    <td class="text-primary" style="color:#015f4e;font-weight:bold;">
                                         [[${info.getCompanyPrice()}]]
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <strong>
                                            <span class="glyphicon glyphicon-euro text-primary" style="color:orange;"></span>
                                               <strong style="color:#015f4e;">Employee's Price:
                                            </strong>
                                        </strong>
                                    </td>
                                    <td class="text-primary" style="color:#015f4e;font-weight:bold;">
                                         [[${info.getEmployeePrice()}]]
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <strong >
                                            <span class="glyphicon glyphicon-time text-primary" style="color:#083971;"></span>
                                            <strong style="color:#015f4e;">Specific Time Setting
                                            </strong>
                                        </strong>
                                    </td>
                                    <td class="text-primary" style="color:#015f4e;font-weight:bold;">
                                         [[${tb.getTime}]] &nbsp; [[${tb.getDate}]] 
                                    </td>
                                </tr>
                    ...
                    <div>
                    <a href="addPrice" class="button-29" role="button">
                        Edit Price
                    </a> 
                    </div>
                    
                    <div>
                     <a href="addTime" class="button-29" role="button">
                        Edit Time
                    </a>
                    </div>
                </div>
