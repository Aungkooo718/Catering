...
<body>
   <input type="checkbox" id="menu-toggle">
       ...
       <div id="feedbackDialog" style="z-index:3" >
        <div class="dialogContent">
            ...
            <form th:action="@{/addFeedback}" method="post">
                ...
                <input type="hidden" name="updateAvoidMeat" value="updateAvoidMeat">
        ...
        <form class="well form-horizontal" th:object="${avoid}" th:action="@{/update}" method="post" id="contact_form">
    <fieldset>
        <div class="row">
            <div class="col-md-3">
                <img alt="" style="opacity:0.7;width:800px;height:250px;margin-left:100px;margin-bottom:40px;margin-top:30px;" title="" class="img-circle img-thumbnail isTooltip"
    ...
    <strong th:text="${session.message}"></strong>
                ...
                <!-- Text input-->
<h3 class="modern-heading">Update Avoid Meat</h3>                
                ...
                <button style="margin-left:300px;" class="btn btn-warning" onclick="location.href='/avoidMeat'">Back</button>
                	<input type="submit" style="margin-right:300px;" class="btn btn-primary" value="Update"/>
                </div>
                </div>
                </fieldset>
                </form>
