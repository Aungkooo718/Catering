...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css" integrity="sha512-iecdLmaskl7CVkqkXNQ/ZH/XLlvWZOJyj7Yy7tcenmpD1ypASozpmT/E0iPtmFIB46ZmdtAc9eNBvH0H/ZpiBw==" crossorigin="anonymous" referrerpolicy="no-referrer" />
    <link rel="stylesheet" href="css/Vouncher.css">
...
<body class="mainbody" style="background-color:LightSteelBlue;">
   <input type="checkbox" id="menu-toggle">
    ...
    <div class="main-content" >
        ...
        <main>
                     ...
                     <div class="container">
        <div class="title">Weekly Vouncher</div>
        <form action="UpdateVoucher" method="post" th:object="${voucher}">
            <div class="user_details">
                <div class="input_pox">
                    <span class="datails">Vouncher Id</span>
                    <select name="id">
  			<option th:each="lan: ${vouchers}" th:value="${lan.id}" th:text="${lan.id}"></option>
			</select>
                </div>
              
                <div class="input_pox">
                    <span class="datails">Cashier</span>
                    <select name="cashier" >
                      <option th:each="lan: ${emp}" th:value="${lan.name}" th:text="${lan.name}"></option>
                      
                    </select>
                </div>
                <div class="input_pox">
                  <span class="datails">Received By</span>
              ...
              <div class="input_pox">
                <span class="datails">Approved by</span>
