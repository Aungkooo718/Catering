...
<div class="form-container" th:if="${session.role=='ADMIN' and session.Doorlog!='555555' and session.roleCheck=='ADMIN'}">
<h2 style="text-align:center;color:blue;"><b>Edit Employee</b></h2>
  <form id="edit_form" name="updateForm" th:action="@{/updateEmployee}" th:object="${emp}" method="post">
    <label for="name">Name</label>
    <input type="text" th:field="*{name}" id="Name" readonly="readonly" th:value="*{name}" placeholder="Name" onkeyup="validateName()">
    <span id="nameError" class="error-message"></span>

    <label for="email">Email</label>
    <input type="text" th:field="*{email}" readonly="readonly" th:value="*{email}" id="Email" placeholder="Email" onkeyup="validateName()">
	<span id="emailError" class="error-message"></span>
	
    <label for="staffId">Staff ID</label>
    <input type="text" th:field="*{staffId}" readonly="readonly" th:value="*{staffId}" id="Staff" placeholder="Staff ID" onkeyup="validateName()">
	<span id="staffError" class="error-message"></span>
	
    <label for="doorLogNo">Door Log</label>
    <input type="text" th:field="*{doorLogNo}" readonly="readonly" th:value="*{doorLogNo}" id="Doorlog" placeholder="Door Log No" onkeyup="validateName()">
	<span id="doorlogError" class="error-message"></span>
	
    <label for="exampleFormControlSelect1">Role</label>
    <select class="form-control" id="exampleFormControlSelect1" th:field="*{role}" th:value="*{role}" disabled>
      <option value="Operator" th:selected="${emp.role == 'Operator'}">Operator</option>
      <option value="ADMIN" th:selected="${emp.role == 'ADMIN'}">ADMIN</option>
    </select>

    <label for="department">Department</label>
    <input type="text" th:field="*{department}" readonly="readonly" th:value="*{department}" id="Department" placeholder="Department" onkeyup="validateName()">
	<span id="deptError" class="error-message"></span>
	
    <div class="button-group">
      <a href="/employees" style="text-decoration:none;text-align:center" type="button" class="cancel-button">Cancel</a>
       <input type="submit" onclick="GEEKFORGEEKS(event)" disabled value="Update Employee" class="submit-button">
    </div>
  </form>
</div>
...
<div class="form-container" th:if="${session.role=='ADMIN' and session.Doorlog!='555555' and session.roleCheck!='ADMIN'}">
 <h2 style="text-align:center;color:blue;"><b>Edit Employee</b></h2>
  <form id="edit_form" name="updateForm" th:action="@{/updateEmployee}" th:object="${emp}" method="post">
    ...
    <label for="email">Email</label>
    <input type="text" th:field="*{email}" th:value="*{email}" id="Email" placeholder="Email" onkeyup="validateName()">
	<span id="emailError" class="error-message"></span>
	
    <label for="staffId">Staff ID</label>
    <input type="text" th:field="*{staffId}" th:value="*{staffId}" id="Staff" placeholder="Staff ID" onkeyup="validateName()">
	<span id="staffError" class="error-message"></span>
	
    <label for="doorLogNo">Door Log</label>
    <input type="text" th:field="*{doorLogNo}" th:value="*{doorLogNo}" id="Doorlog" placeholder="Door Log No" onkeyup="validateName()">
	<span id="doorlogError" class="error-message"></span>
	
    <label for="exampleFormControlSelect1">Role</label>
    <select class="form-control" id="exampleFormControlSelect1" th:field="*{role}" th:value="*{role}" >
      <option value="Operator" th:selected="${emp.role == 'Operator'}">Operator</option>
      <option value="ADMIN" th:selected="${emp.role == 'ADMIN'}">ADMIN</option>
    </select>

    <label for="department">Department</label>
    <input type="text" th:field="*{department}" th:value="*{department}" id="Department" placeholder="Department" onkeyup="validateName()">
	<span id="deptError" class="error-message"></span>
	
    <div class="button-group">
      <a href="/employees" style="text-decoration:none;text-align:center" type="button" class="cancel-button">Cancel</a>
       <input type="submit" onclick="GEEKFORGEEKS(event)" value="Update Employee" class="submit-button">
    </div>
  </form>
</div>           
<div class="form-container" th:if="${session.role=='ADMIN' and session.Doorlog=='555555'}">
 <h2 style="text-align:center;color:blue;"><b>Edit Employee</b></h2>
  <form id="edit_form" name="updateForm" th:action="@{/updateEmployee}" th:object="${emp}" method="post">
    <label for="name">Name</label>
    <input type="text" th:field="*{name}" id="Name" readonly="readonly" th:value="*{name}" placeholder="Name" onkeyup="validateName()">
    ...
    function validateName() {
    	  ...
    	  var doorlogInput = document.getElementById("Doorlog");
    	  var doorlogError = document.getElementById("doorlogError");
    	  ...
    	  if (staffInput.value.trim() === "") {
    		  staffError.innerHTML = "Staff Id can't be empty!";
    	  ...
    	  if (!staffRegex.test(doorlogInput.value)) {
  		    doorlogError.innerHTML = "Please enter numbers only.";
  		    doorlogInput.classList.add("error");
  		  } else {
  		    doorlogError.innerHTML = "";
  		    doorlogInput.classList.remove("error");
  		  }
    	  if (deptInput.value.trim() === "") {
      	    deptError.innerHTML = "Department can't be empty!";
...
function GEEKFORGEEKS(event) {
  ...
  var staffError = document.getElementById("staffError");
  var doorlog = document.getElementById("Doorlog");
  var doorlogError = document.getElementById("doorlogError");
  ...
  if (staff.value.trim() === "") {
	  staffError.innerHTML = "Email can't be empty!";
	    event.preventDefault();
	  }
  if (doorlog.value.trim() === "") {
	  doorlogError.innerHTML = "Email can't be empty!";
	    event.preventDefault();
	  }
  if (department.value.trim() === "") {
	  deptError.innerHTML = "Email can't be empty!";
	    event.preventDefault();
	  }
}
</script>
