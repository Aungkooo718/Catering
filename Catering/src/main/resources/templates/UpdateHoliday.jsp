...
<body class="mainbody">
   <input type="checkbox" id="menu-toggle">
    ...
    <div class="main-content">
        ...
        <div class="dialogContent">
            ...
            <form th:action="@{/addFeedback}" method="post">
                ...
                <input type="hidden" name="updateHoli" value="updateHoli">
        ...
        <form class="well form-horizontal" th:object="${Holiday}" th:action="@{/upHoliday}" method="post" id="contact_form">
    <fieldset>
        <div class="row">
            <div class="col-md-3">
    ...
    <strong th:text="${session.message}"></strong>
                ...
                <!-- Text input-->
                <h3 style="text-align:center;letter-spacing:3px;margin-bottom:30px;"><b>Update Holidays</b></h3>
    ...
    <div class="input-group">
      ...
      <select class="form-control" name="day" onchange="updatePrice()" id="dropDownList" th:field="*{day}">
        ...
        <option value="Sunday">Sunday</option> 
                ...
                <div class="form-group">
                <button style="margin-left:300px;" class="btn btn-warning" onClick="location.href='/holidayView'">Cancel</button>
