...
<body class="mainbody">
   <input type="checkbox" id="menu-toggle">
    ...
    <div class="main-content">
        ...
        <form class="well form-horizontal" th:object="${restaurant}" th:action="@{/updateRestaurant}" method="post" id="contact_form">
    <fieldset>
         <div class="row">
            <div class="col-md-3">
 <img alt="Usuario" src="/images/restaurant.jpg" class="circular-image" style="">
    ...
    <strong th:text="${session.message}"></strong>
                ...
                <!-- Text input-->
      <h3 class="modern-heading">Edit Restaurant Info</h3>
                ...
                <a href="/restaurants" style="margin-left:300px;" class="btn btn-warning" >Back</a>
                	<input type="submit" style="margin-right:300px;" class="btn btn-primary" value="Edit Restaurant"/>
                </div>
                </div>
                </fieldset>
                </form>
