...
<head>
    ...
    <!-- DataTables CDN   <link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/v/dt/dt-1.11.3/datatables.min.css"/>
            ...
            <div  class="col-lg-12">
                <div style="background-color:#cec4c4;" class="main-box no-header clearfix">
                    <div class="main-box-body clearfix">
                        &nbsp;&nbsp;&nbsp;<h3>Unregister and Eat Lunch Detail</h3>
                                ...
                                <tbody>
                                    <tr  th:each="emp : ${employee}">
                                        <td>
                                            ...
                                            <a href="#" class="user-link" style="font-weight: bold;" th:text="${emp.name}"></a>
                                            <span class="user-subhead" style="font-weight: bold;" th:text="${emp.doorLogNo}"></span>
                                        </td>
                                        <td th:text="${date}"></td>
                                        <td class="text-center">
                                            <span class="label label-danger">Unregister-Eat</span>
                                        </td>
