...
body     {width: 100%; background-color: #ffffff; margin:0; padding:0; -webkit-font-smoothing: antialiased;font-family: Arial, Helvetica, sans-serif; font-size: 18px;}
      ...
      <table width="100%"  border="0" cellpadding="0" cellspacing="0" align="center" > 
        ...
        <tr>
          <td width="50%" class="center" style="font-size: 12px; 
            ...
            <br>
            <p style="color: red;font-size: 22px;"><b> Alert Friday 2:00 PM</b></p>
       ...
       <tr>
          <td width="50%" class="center" style="font-size: 12px; color: black; font-weight: normal; text-align: center; font-family: Arial, Helvetica, sans-serif; line-height: 10px; vertical-align: middle; padding: 0px 10px 10px 10px; " >
            ...
            <p><strong> You Can Order NOW!! For This Week. </strong></p>
            <p><strong> *Check The System Right Now*</strong></p>
         </td>
       </tr>
        <br><br>
       <tr>
