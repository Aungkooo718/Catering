...
<head>
    ...
    <title>Reset Your 21bitcoin Password</title>
    <!--[if !mso]>
      <!-- -->
...
<body style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;
 ...
 padding-bottom: 9px; padding-left: 18px;' valign="top">
                                                                <a href="https://21bitcoin.app" style="mso-line-height-rule: exactly;
 -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; color: #2a2a2a;
 font-weight: normal; text-decoration: none" target="_blank" title="21bitcoin is the
 ...
 exactly; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; color:
 #f57153; font-weight: normal; text-decoration: none" target="_blank" title="">
                                                                        <img align="center" alt="Forgot Password"
                                                                            class="mcnImage"
                                                                            src="https://uploads-ssl.webflow.com/5f636d92fe29d5560a7c81c9/5fd93589f228d319bf33eee2_keys.gif"
 ...
 padding: 0'><span style="text-transform:uppercase">Forgot your password?</span></h2>
 ...
 color: #2a2a2a; font-family: "Asap", Helvetica, sans-serif; font-size: 16px;
 line-height: 150%; text-align: center; padding-top:9px; padding-right: 18px;
 padding-bottom: 9px; padding-left: 18px;' valign="top">We cannot simply send you your old password. A unique link to reset your
 ...
 padding-right:48px; padding-bottom:24px; padding-left:48px;" valign="middle">
                                                                                <a class="mcnButton " href="${link}"
                                                                                    style="mso-line-height-rule: exactly;
 -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; display: block; color: #0003ff;
 ...
 Helvetica, sans-serif; font-size: 12px;" valign="top">
                                                                <div style="text-align: center;"><i>Copyright © 2021
                                                                        21bit e.U.</i>
 ...
 none" target="_blank">
                                                                    ...
                                                                    </a><br><br><b>Address</b> Yangon,Hlaing MICT Park, DAT
